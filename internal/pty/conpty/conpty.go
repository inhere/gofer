// Vendored from github.com/UserExistsError/conpty (single-file conpty.go).
//   upstream: https://github.com/UserExistsError/conpty
//   commit:   aff362cbe133d2e0818f6eeaffd66c84957a0cf1 (master, 2026-07-03)
//   license:  MIT (see LICENSE in this directory)
// Copied in per WEB-03 design §13 to self-maintain the Windows pty backend
// without pulling a third-party module: it depends only on golang.org/x/sys/
// windows (already a dependency) + stdlib. Import path is
// github.com/inhere/gofer/internal/pty/conpty. Only this header was added — the
// code below (build tags + package) is upstream verbatim.

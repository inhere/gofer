...
agent-bridge project add hyy-ai-inspect --host-path D:/work/inhere/hyy-ai-inspect --container-path /workspace
agent-bridge agent list
agent-bridge job run --project hyy-ai-inspect --agent codex --cwd tools/dev-agent-bridge "检查当前设计"
...
```bash
agent-bridge project list
agent-bridge project show hyy-ai-inspect
...
agent-bridge project remove hyy-ai-inspect
```
...
```bash
agent-bridge job run --project hyy-ai-inspect --agent codex --cwd . "检查当前设计"
...
```json
{
  ...
  "status": "done",
  "exit_code": 0,
  "cwd": "D:/work/inhere/hyy-ai-inspect/tools/dev-agent-bridge",
